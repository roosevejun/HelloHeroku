...
<div class="container">
    <form role="form" class="form-signin" name="supeComSearchForm" id="supeComSearchForm" action="">
        ...
        <input type="text" autofocus="" id="PROJECTNAME" name="PROJECTNAME" required="" placeholder="项目名称" class="form-control">
        <input type="text" required="" id='AREANO' name="AREANO" placeholder="所在省份" class="form-control">
        <input type="text" required=""  id="LEVELID" name="LEVELID"placeholder="项目类型" class="form-control">
        <input type="text" required=""  id="RANKID" name="RANKID"placeholder="项目子类型" class="form-control">
